...
nano HVG_genetic_5000_cell_true_label_L2_L3.sh
...
for ct in "${celltypes[@]}"; do
    ...
    jobfile="${SCRIPT_DIR}/HVG_genetic_5000_cell_true_label_${ct}.sh"
    cat > "$jobfile" <<EOF
#!/bin/bash
...
#SBATCH --mem=40g
#SBATCH --job-name=HVG_genetic_5000_cell_true_label_${ct}
...
cd ${SCRIPT_DIR}
python3.8 ${SCRIPT_DIR}/HVG_genetic_5000_cell_true_label_${ct}.py
EOF
    
    # Create the SLURM job script
    pyfile="${SCRIPT_DIR}/HVG_genetic_5000_cell_true_label_${ct}.py"
    cat > "$pyfile" <<EOF
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_genetic_5000_cell_true_label_{par_keep_cell_type}_3.csv"
...
nano HVG_genetic_5000_cell_true_label_L4_L6.sh
...
#SBATCH --job-name=HVG_genetic_5000_cell_true_label_L4_L6
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/HVG_genetic_5000_cell_true_label_L4_L6.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano HVG_genetic_5000_cell_true_label_L4_L6.py
