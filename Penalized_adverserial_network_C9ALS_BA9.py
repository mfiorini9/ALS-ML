...
nano penalized_adverserial_network_C9ALS_BA9.sh
...
#SBATCH --job-name=penalized_adverserial_network_C9ALS_BA9
...
$PYTHONENV0/bin/python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/penalized_adverserial_network_C9ALS_BA9.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano penalized_adverserial_network_C9ALS_BA9.py
...
for par_keep_cell_type in celltype_list:
    ...
    ###################################
    # create new_annData object with only c9ALS and not sALS
    ###################################
