...
nano optimal_LOO_0.9995_weighted_LIME_SFTLD_BA9_all_cells_narval_2.sh
...
#SBATCH --job-name=optimal_LOO_0.9995_weighted_LIME_SFTLD_BA9_all_cells_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/optimal_LOO_0.9995_weighted_LIME_SFTLD_BA9_all_cells_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano optimal_LOO_0.9995_weighted_LIME_SFTLD_BA9_all_cells_narval_2.py
...
for donor in sample_IDs:
    for _ in range(5):
        ...
        for donor_id in adata_train.obs['orig.ident'].unique():
            ...
            sc.pp.neighbors(donor_adata, n_neighbors=10, use_rep='X')
