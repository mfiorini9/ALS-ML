...
nano TxD_subtypes_control_python_BA9.sh
...
#SBATCH --job-name=TxD_subtypes_control_python_BA9
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/TxD_subtypes_control_python_BA9.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano TxD_subtypes_control_python_BA9.py
...
for par_keep_cell_type in cell_types:
    ...
    pseudobulk["Group"] = pseudobulk.index.to_series().apply(
        lambda x: (
            ...
            else "SALS" if x.endswith("_1")
            else "C9ALS" if x.endswith("_2")
            else "SFTLD" if x.endswith("_3")
            else "C9FTLD" if x.endswith("_4")
            else "Unknown"
        )
    )
...
out_path = "/home/fiorini9/scratch/machine_learning_ALS/model_outs/TxD_subtypes_control_python_BA9.csv"
