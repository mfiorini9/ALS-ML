...
generate_py_file() {
    ...
    cat <<EOF > "/home/fiorini9/scratch/machine_learning_ALS/scripts/permutation_weighted_LIME_C9FTLD_BA9_${CELL}_narval_2.py"
## generalizable model
...
EOF
    ...
    echo "Py file created for cell type : $CELL at /home/fiorini9/scratch/machine_learning_ALS/scripts/permutation_weighted_LIME_C9FTLD_BA9_${CELL}_narval_2.py"
}
...
generate_and_submit_job() {
    ...
    cat <<EOF > "/home/fiorini9/scratch/machine_learning_ALS/scripts/permutation_weighted_LIME_C9FTLD_BA9_${CELL}_narval_2.sh"
#!/bin/bash  
#SBATCH --account=def-grouleau
#SBATCH --time=07-00:00           # time (DD-HH:MM)
#SBATCH --cpus-per-task=1
#SBATCH --mem=40g          # memory per cor
#SBATCH --job-name=permutation_weighted_LIME_C9FTLD_BA9_${CELL}_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/permutation_weighted_LIME_C9FTLD_BA9_${CELL}_narval_2.py

EOF
    
    # Submit the job using sbatch and capture the job ID
    JOB_SUBMISSION_OUTPUT=$(sbatch "/home/fiorini9/scratch/machine_learning_ALS/scripts/permutation_weighted_LIME_C9FTLD_BA9_${CELL}_narval_2.sh")
