salloc -A def-tdurcan --time=0-1 -c 1 --mem=40g
...
rm fix_generalizable_HVG_Astro_subtype_combat_LOSO.sh
nano fix_generalizable_HVG_Astro_subtype_combat_LOSO.sh
...
#SBATCH --job-name=fix_generalizable_HVG_Astro_subtype_combat_LOSO
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/fix_generalizable_HVG_Astro_subtype_combat_LOSO.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano fix_generalizable_HVG_Astro_subtype_combat_LOSO.py
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/All_HVGs_combat_LOSO_generalizable_subtype_control_Pineda_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_3.csv"
