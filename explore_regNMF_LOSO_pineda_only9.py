...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
L3_L5   ##### JOB ID: 43250222

cd /home/fiorini9/scratch/machine_learning_ALS/scripts

nano test_SFTLD_BA9_regNMF9_narval_2.sh
...
#SBATCH --job-name=test_SFTLD_BA9_regNMF9_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_SFTLD_BA9_regNMF9_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_SFTLD_BA9_regNMF9_narval_2.py
...
#/home/fiorini9/scratch/machine_learning_ALS/model_outs/regNMF_model_report9_CombatSeq_SFTLD_BA9_L2_L3_narval_2.csv
...
for par_keep_cell_type in cell_types:
    ...
    class SupervisedNMF(nn.Module):
        def __init__(self, n_cells, n_genes, n_components, n_domains, lambda_subj=1, lambda_disease=2, lambda_domain=1):
            super().__init__()
    ...
    out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regNMF_model_report9_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
