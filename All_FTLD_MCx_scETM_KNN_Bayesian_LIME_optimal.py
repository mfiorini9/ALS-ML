...
rm test_All_FTLD_BA4_ETM_Endo_LIME_narval_4.sh
nano test_All_FTLD_BA4_ETM_Endo_LIME_narval_4.sh
...
#SBATCH --job-name=test_All_FTLD_BA4_ETM_Endo_LIME_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_All_FTLD_BA4_ETM_Endo_LIME_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_All_FTLD_BA4_ETM_Endo_LIME_narval_4.py
...
# Ensure par_n_epochs is at least 300
if par_n_epochs < 300:
    par_n_epochs = 300
...
for donor in sample_IDs:
    ...
    explainer = lime.lime_tabular.LimeTabularExplainer(df.values, class_names=['PN', par_label], feature_names = np.arange(0, adata_test_ETM.obsm["delta"].shape[1]).tolist(), verbose=True, mode='classification')
    ...
    # Map Group numbers to names
    group_mapping = {'C9FTLD': 1, 'SFTLD': 1, 'PN': 0}
    cell_metadata_train['Group'] = cell_metadata_train['Group'].map(group_mapping)
    cell_metadata_test['Group'] = cell_metadata_test['Group'].map(group_mapping)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_model_report2_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_narval_2_KNN_Bayesian_LIME_optimal.csv"
results_df.to_csv(out_path, index=False)


topic_df_df = pd.DataFrame(topic_df)
topic_df_df["cell_type"] = par_keep_cell_type
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_topic_gene_info_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_narval_2_KNN_Bayesian_LIME_optimal.csv"
topic_df_df.to_csv(out_path, index=False)

LIME_feature_df_df = pd.DataFrame(LIME_feature_df)
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_LIME_feature_importance_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_narval_2_KNN_Bayesian_LIME_optimal.csv"
