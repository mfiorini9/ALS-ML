...
nano balanced_optimal_LOO_0_weighted_LIME_All_FTLD_BA9_all_cells_narval_2.sh
...
#SBATCH --job-name=balanced_optimal_LOO_0_weighted_LIME_All_FTLD_BA9_all_cells_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/balanced_optimal_LOO_0_weighted_LIME_All_FTLD_BA9_all_cells_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano balanced_optimal_LOO_0_weighted_LIME_All_FTLD_BA9_all_cells_narval_2.py
...
for par_keep_cell_type in cell_types:
    ...
    out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/balanced_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
