...
nano permutation_weighted_LIME_C9ALS_BA4_Oligo_narval_2.sh
nano permutation_weighted_LIME_C9ALS_BA4_Oligo_narval_2.py


## run this in narval

salloc -A def-grouleau --time=0-8 -c 4 --mem=100g
...
nano permutation_weighted_LIME_all_conditions_BA4_L5_narval_2.sh
...
#SBATCH --job-name=permutation_weighted_LIME_all_conditions_BA4_L5_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/permutation_weighted_LIME_all_conditions_BA4_L5_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano permutation_weighted_LIME_all_conditions_BA4_L5_narval_2.py
...
# Parameters
###################################
## Here we are keeping all conditions
par_prep = "CombatSeq"
par_brain_region = "BA4"
par_status = "all_conditions" ### IMPLEMENT THIS
#remove = ["C9ALS", "SFTLD", "SALS"] ## C9ALS, C9FTLD, SALS, SFTLD; choose 3 of the 4. 
...
###################################
# Randomly subset 30000 cells
###################################

if adata.n_obs >= 30000:
    # Randomly select 30000 cells
    np.random.seed(42)  
    random_cells = np.random.choice(adata.obs_names, size=30000, replace=False)
    # Subset the AnnData object to retain only those cells
    adata = adata[random_cells, :].copy()
    # View the result
    print(adata)
else:
    print("The dataset has fewer than 30,000 cells.")
