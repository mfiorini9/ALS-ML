...
nano HVG_5_class_randomized_BA4_L2_L3.sh
...
for ct in "${celltypes[@]}"; do
    ...
    jobfile="${SCRIPT_DIR}/HVG_5_class_randomized_BA4_${ct}.sh"
    #rm $jobfile
    cat > "$jobfile" <<EOF
#!/bin/bash
...
#SBATCH --mem=100g
#SBATCH --job-name=HVG_5_class_randomized_BA4_${ct}
...
cd ${SCRIPT_DIR}
python3.8 ${SCRIPT_DIR}/HVG_5_class_randomized_BA4_${ct}.py
EOF
    
    # Create the SLURM job script
    pyfile="${SCRIPT_DIR}/HVG_5_class_randomized_BA4_${ct}.py"
    #rm $pyfile
    cat > "$pyfile" <<EOF
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_5_class_randomized_BA4_{par_keep_cell_type}_3.csv"
