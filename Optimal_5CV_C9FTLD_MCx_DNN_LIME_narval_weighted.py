...
cell_types=("L3_L5" "L2_L3" "L4_L6" "L4_L5" "L5_L6" "L6" "PV" "5HT3aR" "Rosehip" "SOM" "Oligo" "Astro" "OPC" "Micro" "T_Cell" "Mural" "Endo" "Fibro" "L5")

# Loop through each cell type
for cell in "${cell_types[@]}"; do
    # Modify the script name by replacing 5HT3aR with the current cell type
    job_script="optimal_5CV_weighted_LIME_C9FTLD_BA4_${cell}_narval.sh"

    # Submit the job using sbatch
    job_output=$(sbatch "$job_script")

    # Extract and print the job ID (which is the first number in the sbatch output)
    job_id=$(echo $job_output | awk '{print $4}')
    echo "Job for cell type $cell submitted with job ID: $job_id"
done
...
nano optimal_5CV_weighted_LIME_C9FTLD_BA4_L5_narval.sh
...
#SBATCH --job-name=optimal_5CV_weighted_LIME_C9FTLD_BA4_L5_narval
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/optimal_5CV_weighted_LIME_C9FTLD_BA4_L5_narval.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano optimal_5CV_weighted_LIME_C9FTLD_BA4_L5_narval.py
...
remove = ["SALS", "C9FTLD", "C9ALS"] ## C9ALS, C9FTLD, SALS, C9FTLD; choose 3 of the 4. 
