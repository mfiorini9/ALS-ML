...
nano permutation_unweighted_LIME_SALS_BA4_L3_L5_narval.sh
...
#SBATCH --job-name=permutation_unweighted_LIME_SALS_BA4_L3_L5_narval
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/permutation_unweighted_LIME_SALS_BA4_L3_L5_narval.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano permutation_unweighted_LIME_SALS_BA4_L3_L5_narval.py
...
file_path = f'/home/fiorini9/scratch/machine_learning_ALS/model_outs/pineda_LIME_unweighted_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval.csv'
...
# Step 3: Convert 'Mean_z_score_across_donors' to numeric
df['Mean_z_score_across_donors'] = pd.to_numeric(df['Mean_z_score_across_donors'], errors='coerce')

# Step 4: Sort the DataFrame by 'Mean_z_score_across_donors' in descending order
df = df.sort_values(by='Mean_z_score_across_donors', ascending=False)

# Calculate the percentile rank based on 'Mean_z_score_across_donors'
df['percentile_rank'] = df['Mean_z_score_across_donors'].rank(pct=True) * 100

# Step 5: Filter rows where 'Mean_z_score_across_donors' is greater than or equal to 1
df = df[df['Mean_z_score_across_donors'] >= 1]

# Step 6: Select only the 'feature' and 'Mean_z_score_across_donors' columns
df = df[['feature', 'Mean_z_score_across_donors', 'percentile_rank']]
...
file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/pineda_LIME_unweighted_percentile_rank_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval.csv"
...
## write csv file
file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/permutation_unweighted_report_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval.csv"
df.to_csv(file_name, index=False)
