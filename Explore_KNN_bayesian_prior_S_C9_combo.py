...
nano optimal_LOO_0delta_absScaling_weighted_Knn_threshold_sweep_LIME_SALS_BA4_all_cells_narval_2.sh
...
#SBATCH --job-name=optimal_LOO_0delta_absScaling_weighted_Knn_threshold_sweep_LIME_SALS_BA4_all_cells_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/optimal_LOO_0delta_absScaling_weighted_Knn_threshold_sweep_LIME_SALS_BA4_all_cells_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano optimal_LOO_0delta_absScaling_weighted_Knn_threshold_sweep_LIME_SALS_BA4_all_cells_narval_2.py
...
par_status = "C9ALS" ## For now we'll use the LIME genes from C9ALS just for exploration
remove = ["SFTLD", "C9FTLD"]
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_abs_scaling_sweep_confidence_threshold_narval_2.csv"
