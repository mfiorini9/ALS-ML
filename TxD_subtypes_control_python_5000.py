...
nano TxD_subtypes_control_python_5000.sh
...
#SBATCH --job-name=TxD_subtypes_control_python_5000
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/TxD_subtypes_control_python_5000.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano TxD_subtypes_control_python_5000.py
...
for par_keep_cell_type in cell_types:
    ...
    plt.savefig(
        f"/home/fiorini9/scratch/machine_learning_ALS/temp_figures/pseudobulk_PCA_subtype_control_{par_keep_cell_type}.pdf",
        format="pdf"
    )
...
out_path = "/home/fiorini9/scratch/machine_learning_ALS/model_outs/TxD_subtypes_control_python_5000.csv"
