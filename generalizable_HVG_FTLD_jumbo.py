...
salloc -A def-sfarhan --time=0-2 -c 1 --mem=200g
...
nano generalizable_HVG_L5_FTLD_jumbo.sh
...
#SBATCH --job-name=generalizable_HVG_L5_FTLD_jumbo
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/generalizable_HVG_L5_FTLD_jumbo.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano generalizable_HVG_L5_FTLD_jumbo.py
...
lime_file_BA4 = f'/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_LOO_optimal_delta_{par_prep}_All FTLD_BA4_{par_keep_cell_type}_0_abs_case_control_narval_2.csv'
lime_file_BA9 = f'/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_LOO_optimal_delta_{par_prep}_All FTLD_BA9_{par_keep_cell_type}_0_abs_case_control_narval_2.csv'
...
# Combine X matrices
X_combined = vstack([adata_pineda_BA4.X, adata_pineda_BA9.X, adata_li_BA4.X, adata_li_BA9.X])
X_combined.shape
...
obs_combined = pd.concat([adata_pineda_BA4.obs, adata_pineda_BA9.obs, adata_li_BA4.obs, adata_li_BA9.obs])
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/generalizable_Pineda_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_FTLD_{par_keep_cell_type}.csv"
...
sample_IDs_combo = set(
    adata_combined.obs.loc[adata_combined.obs['Dataset'].isin(['Li']), 'Donor_comp']
)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/generalizable_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_FTLD_{par_keep_cell_type}_unbalanced.csv"
results_df.to_csv(out_path, index=False)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/generalizable_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_FTLD_{par_keep_cell_type}_balanced_2X.csv"
results_df.to_csv(out_path, index=False)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/generalizable_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_FTLD_{par_keep_cell_type}_balanced_1X.csv"
results_df.to_csv(out_path, index=False)