...
nano generalizable_300_NMF_L5_ALSand_FTLD_jumbo.sh
...
#SBATCH --job-name=generalizable_300_NMF_L5_ALSand_FTLD_jumbo
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/generalizable_300_NMF_L5_ALSand_FTLD_jumbo.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano generalizable_300_NMF_L5_ALSand_FTLD_jumbo.py
...
for donor in sample_IDs:
    ...
    ## NMF model for train
    ############################
    model = NMF(n_components=300, init='random', tol=1e-3, random_state=42, max_iter = 10000, verbose=True) 
    ## Fit the model
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/ALS_and_FTLD_generalizable_NMF_300_Pineda_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}.csv"
...
print(adata_combined.obs.groupby(['Group', 'Dataset']).size())
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/ALS_and_FTLD_generalizable_NMF_300_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_unbalanced.csv"
results_df.to_csv(out_path, index=False)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/ALS_and_FTLD_generalizable_NMF_300_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_balanced_1X.csv"
results_df.to_csv(out_path, index=False)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/ALS_and_FTLD_generalizable_NMF_300_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_balanced_2X.csv"
results_df.to_csv(out_path, index=False)