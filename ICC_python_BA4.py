...
#SBATCH --job-name=ICC_python_BA4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/ICC_python_BA4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano ICC_python_BA4.py
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/ICC_python_BA4.csv"
