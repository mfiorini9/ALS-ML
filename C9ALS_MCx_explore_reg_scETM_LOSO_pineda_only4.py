salloc -A def-grouleau --time=0-2 -c 1 --mem=10g
...
module load StdEnv/2020 
module load python/3.8.10
PYTHONENV0=/home/fiorini9/scratch/machine_learning_ALS/ENVscRNA
...
nano test_C9ALS_BA4_regETM_L5_L6_epochs_sweep_300topics_narval_4.sh
...
#SBATCH --job-name=test_C9ALS_BA4_regETM_L5_L6_epochs_sweep_300topics_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_C9ALS_BA4_regETM_L5_L6_epochs_sweep_300topics_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_C9ALS_BA4_regETM_L5_L6_epochs_sweep_300topics_narval_4.py
...
for par_keep_cell_type in cell_types:
    ...
    for par_n_epochs in n_epochs_list:
        print(par_n_epochs)
        ###################################
        # Cell Specific parameters -- L5_L6
        ###################################
