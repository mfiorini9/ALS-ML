...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
L2_L3   ##### JOB ID: 43265174

cd /home/fiorini9/scratch/machine_learning_ALS/scripts

rm test_All_FTLD_BA9_gene_ETM_L2_L3_LIME_narval_4.sh
nano test_All_FTLD_BA9_gene_ETM_L2_L3_LIME_narval_4.sh

#!/bin/bash 
#SBATCH --account=def-sfarhan
#SBATCH --time=03-00:00           # time (DD-HH:MM)
#SBATCH --ntasks=1
#SBATCH --mem=250g          # memory per cor
#SBATCH --job-name=test_All_FTLD_BA9_gene_ETM_L2_L3_LIME_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_All_FTLD_BA9_gene_ETM_L2_L3_LIME_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

rm test_All_FTLD_BA9_gene_ETM_L2_L3_LIME_narval_4.py
nano test_All_FTLD_BA9_gene_ETM_L2_L3_LIME_narval_4.py
...
for donor in sample_IDs:
    ...
    ###################################
    ## Concatenate optimal topics with HVGs
    ###################################
    ## Lets try to visualize the embeddings
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_optimal_genes_ETM_KNN_bayesian_model_report2_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
