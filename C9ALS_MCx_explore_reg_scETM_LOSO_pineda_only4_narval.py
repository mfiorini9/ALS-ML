...
rm test_C9ALS_BA4_regETM_L3_L5_epochs_sweep_200topics_narval_4.sh
nano test_C9ALS_BA4_regETM_L3_L5_epochs_sweep_200topics_narval_4.sh
...
#SBATCH --job-name=test_C9ALS_BA4_regETM_L3_L5_epochs_sweep_200topics_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_C9ALS_BA4_regETM_L3_L5_epochs_sweep_200topics_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


nano test_C9ALS_BA4_regETM_L3_L5_epochs_sweep_200topics_narval_4.py
...
for par_keep_cell_type in cell_types:
    ...
    for par_n_epochs in n_epochs_list:
        ...
        out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs_cedar/model_outs/regETM_model_report2_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_{par_n_topics}_{par_n_epochs}_narval_2.csv"
