...
salloc -A def-tdurcan --time=0-2 -c 1 --mem=200g
...
nano fix_generalizable_HVG_Fibro_ALS_jumbo_ALS_FTLD.sh
...
#SBATCH --job-name=fix_generalizable_HVG_Fibro_ALS_jumbo_ALS_FTLD
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/fix_generalizable_HVG_Fibro_ALS_jumbo_ALS_FTLD.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano fix_generalizable_HVG_Fibro_ALS_jumbo_ALS_FTLD.py
...
#sc.pp.combat(adata_combined, key='Dataset')
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/All_HVGs_fix_generalizable_ALS_FTLD_control_Pineda_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}.csv"
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/All_HVGs_fix_generalizable_ALS_FTLD_control_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_unbalanced.csv"
results_df.to_csv(out_path, index=False)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/All_HVGs_fix_generalizable_ALS_FTLD_control_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_balanced_1X.csv"
results_df.to_csv(out_path, index=False)
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/All_HVGs_fix_generalizable_ALS_FTLD_control_Li_Limone_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_balanced_2X.csv"
results_df.to_csv(out_path, index=False)
