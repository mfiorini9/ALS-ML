...
nano optimal_5CV_weighted_LIME_C9FTLD_BA4_all_cells_narval_2.sh
...
#SBATCH --job-name=optimal_5CV_weighted_LIME_C9FTLD_BA4_all_cells_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/optimal_5CV_weighted_LIME_C9FTLD_BA4_all_cells_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano optimal_5CV_weighted_LIME_C9FTLD_BA4_all_cells_narval_2.py
...
for par_keep_cell_type in cell_types:
    ...
    file_path = f'/home/fiorini9/scratch/machine_learning_ALS/model_outs/pineda_LIME_lambda_0.00025_optimal_genes_{par_brain_region}_{par_status}_{par_keep_cell_type}_narval_2.csv' ## Produced from LIME_outputs_explore3.R
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(np.arange(len(full_dataset)))):
        ...
        accuracy = balanced_accuracy_score(val_labels, val_predictions)
    ...
    ## write csv file
    file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/optimal_gene_set_weighted_5CV_report_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
