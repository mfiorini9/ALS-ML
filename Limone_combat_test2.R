...
#SBATCH --job-name=Limone_combat_BA4
...
Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/Limone_combat_BA4.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano Limone_combat_BA4.R
    ...
    seu <- readRDS('/home/fiorini9/scratch/machine_learning_ALS/base_objects/Limone_All_conditions_BA4.rds')
    ...
    for(seu_celltype in unique(celltype)){
        ...
        ggsave(paste0('/home/fiorini9/scratch/machine_learning_ALS/figures/data_prep/Limone_Combat_UMAP_BA4_Sample_ID_',seu_celltype,'.pdf'), height = 5, width = 5)
        ...
        plot.title = element_text( size =10)) + 
        xlab("UMAP1") + ylab("UMAP2")
        ggsave(paste0('/home/fiorini9/scratch/machine_learning_ALS/figures/data_prep/Limone_Combat_UMAP_BA4_Group_',seu_celltype,'.pdf'), height = 5, width = 5)
        ...
        plot.title = element_text( size =10)) + 
        xlab("UMAP1") + ylab("UMAP2")
        ggsave(paste0('/home/fiorini9/scratch/machine_learning_ALS/figures/data_prep/Limone_No_Combat_UMAP_BA4_Sample_ID_',seu_celltype,'.pdf'), height = 5, width = 5)
        ...
        plot.title = element_text( size =10)) + 
        xlab("UMAP1") + ylab("UMAP2")
        ggsave(paste0('/home/fiorini9/scratch/machine_learning_ALS/figures/data_prep/Limone_No_Combat_UMAP_BA4_Group_',seu_celltype,'.pdf'), height = 5, width = 5)

        ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
        ggsave(paste0('/home/fiorini9/scratch/machine_learning_ALS/figures/data_prep/Limone_Combat_UMAP_BA4_',seu_celltype,'.pdf'), height = 10, width = 10)
        ...
        SaveH5Seurat(pbmc3k_slim, 
                filename = paste0("/home/fiorini9/scratch/machine_learning_ALS/base_objects/Limone_combat_BA4_",seu_celltype,"_int.h5Seurat"),
                overwrite = T,
                verbose = T
                )

        Convert(paste0("/home/fiorini9/scratch/machine_learning_ALS/base_objects/Limone_combat_BA4_",seu_celltype,"_int.h5Seurat"), dest = "h5ad", assay = "RNA")

        saveRDS(pbmc3k_slim, paste0('/home/fiorini9/scratch/machine_learning_ALS/base_objects/Limone_combat_BA4_',seu_celltype,'_int.rds'))
    }
##
