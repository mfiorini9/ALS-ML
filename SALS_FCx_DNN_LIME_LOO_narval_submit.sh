...
generate_py_file() {
    ...
    cat <<EOF > "/home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_SALS_BA9_${CELL}_narval_LOO.py"
## generalizable model
...
EOF
    ...
    echo "Py file created for cell type : $CELL at /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_SALS_BA9_${CELL}_narval_LOO.py"
}
...
generate_and_submit_job() {
    ...
    rm LIME_SALS_BA9_${CELL}_narval_LOO.sh

    # Generate the job script
    cat <<EOF > "/home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_SALS_BA9_${CELL}_narval_LOO.sh"
#!/bin/bash  
#SBATCH --account=def-sfarhan
#SBATCH --time=01-00:00           # time (DD-HH:MM)
#SBATCH --cpus-per-task=1
#SBATCH --mem=100g          # memory per cor
#SBATCH --job-name=LIME_SALS_BA9_${CELL}_narval_LOO
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_SALS_BA9_${CELL}_narval_LOO.py

EOF
    
    # Submit the job using sbatch and capture the job ID
    JOB_SUBMISSION_OUTPUT=$(sbatch "/home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_SALS_BA9_${CELL}_narval_LOO.sh")
