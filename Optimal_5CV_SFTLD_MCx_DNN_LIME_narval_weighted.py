...
for cell in "${cell_types[@]}"; do
    ...
    job_script="optimal_5CV_weighted_LIME_SFTLD_BA4_${cell}_narval.sh"
...
nano optimal_5CV_weighted_LIME_SFTLD_BA4_L5_narval.sh
...
#SBATCH --job-name=optimal_5CV_weighted_LIME_SFTLD_BA4_L5_narval
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/optimal_5CV_weighted_LIME_SFTLD_BA4_L5_narval.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano optimal_5CV_weighted_LIME_SFTLD_BA4_L5_narval.py
