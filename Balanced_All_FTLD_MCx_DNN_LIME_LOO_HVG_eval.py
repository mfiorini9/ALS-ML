...
nano HVGs_LOO_balanced_all_FTLD_BA4_all_cells_narval_2.sh
...
#SBATCH --job-name=HVGs_LOO_balanced_all_FTLD_BA4_all_cells_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/HVGs_LOO_balanced_all_FTLD_BA4_all_cells_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano HVGs_LOO_balanced_all_FTLD_BA4_all_cells_narval_2.py
...
for par_keep_cell_type in cell_types:
    ...
    out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_LOO_report_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
