...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
L4_L5   ##### JOB ID: 43265174

cd /home/fiorini9/scratch/machine_learning_ALS/scripts

nano test_SALS_BA4_ETM_L4_L5_LIME_narval_4.sh
...
#SBATCH --job-name=test_SALS_BA4_ETM_L4_L5_LIME_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_SALS_BA4_ETM_L4_L5_LIME_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_SALS_BA4_ETM_L4_L5_LIME_narval_4.py
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_model_report2_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval_2_KNN_Bayesian_LIME_optimal.csv"
results_df.to_csv(out_path, index=False)


topic_df_df = pd.DataFrame(topic_df)
topic_df_df["cell_type"] = par_keep_cell_type
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_topic_gene_info_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval_2_KNN_Bayesian_LIME_optimal.csv"
topic_df_df.to_csv(out_path, index=False)

LIME_feature_df_df = pd.DataFrame(LIME_feature_df)
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_LIME_feature_importance_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval_2_KNN_Bayesian_LIME_optimal.csv"
