...
nano test_SALS_BA4_regETM_topics_sweep_35_epochs_narval_2.sh
...
#SBATCH --job-name=test_SALS_BA4_regETM_topics_sweep_35_epochs_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_SALS_BA4_regETM_topics_sweep_35_epochs_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_SALS_BA4_regETM_topics_sweep_35_epochs_narval_2.py
...
n_topics_list = [100, 150, 200, 250, 300]
par_n_epochs = 35
...
for par_keep_cell_type in cell_types:
    ...
    for par_n_topics in n_topics_list:
        ...
        del adata, adata_li, adata_train, adata_test
