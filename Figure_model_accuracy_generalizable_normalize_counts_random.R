...
Random performance with NORMALIZED CELL COUNTS
...
## code
    ...
    ## code
        ...
        summary_stats_3_class <- summary_stats
        summary_stats_3_class$group[summary_stats_3_class$group == "control"] <- "Control"
    ##
    ...
    ## code
        ...
        summary_stats_5_class <- summary_stats
        summary_stats_5_class$group[summary_stats_5_class$group == "control"] <- "Control"
    ##
    ...
    ###########################
    ## code
        total_accuracy_combin <- rbind(summary_stats_3_class, summary_stats_5_class)
        ...
        total_accuracy_combin$group <- factor(total_accuracy_combin$group, levels = rev(c("Overall", "Class 1", "Class 2", "Class 3", "Class 4", "Class 5")))
