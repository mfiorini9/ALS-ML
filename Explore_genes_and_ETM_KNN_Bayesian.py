...
nano test_SALS_BA4_genes_ETM_KNN_bayesian_L5_narval_4.sh
...
#SBATCH --job-name=test_SALS_BA4_genes_ETM_KNN_bayesian_L5_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_SALS_BA4_genes_ETM_KNN_bayesian_L5_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_SALS_BA4_genes_ETM_KNN_bayesian_L5_narval_4.py
...
###################################
par_ann_data_Pineda = f"/home/fiorini9/scratch/machine_learning_ALS/base_objects/base_objects/combat_{par_brain_region}_{par_keep_cell_type}_int.h5ad"
par_ann_data_Li = f"/home/fiorini9/scratch/machine_learning_ALS/base_objects/base_objects/Li_combat_{par_brain_region}_{par_keep_cell_type}_int.h5ad"
par_ann_data_Limone = f"/home/fiorini9/scratch/machine_learning_ALS/base_objects/base_objects/Limone_combat_{par_brain_region}_{par_keep_cell_type}_int.h5ad"
...
for donor in sample_IDs:
    ...
    lime_file = f'/home/fiorini9/scratch/machine_learning_ALS_2/model_outs/LIME_LOO_optimal_delta_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_0_abs_case_control_narval_2.csv'
    features = pd.read_csv(lime_file)["gene"].tolist()
    
    # Load model report
    report_file = f"/home/fiorini9/scratch/machine_learning_ALS_2/model_outs/model_report_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
    report_df = pd.read_csv(report_file)
    batch_size = int(report_df.at[0, 'batch_size'])
    learning_rate = report_df.at[0, 'learning_rate']
    
    # Load anndata
    adata_file = f"/home/fiorini9/scratch/machine_learning_ALS/base_objects/base_objects/combat_{par_brain_region}_{par_keep_cell_type}_int.h5ad"
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/genes_ETM_KNN_bayesian_model_report2_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
...
#############################  
    ...
    for _ in range(5):       
        print(f"Processing donor: {donor}")
        num_cells = X_combined_test.shape[0]
        ...
        acc = balanced_accuracy_score(y_test.numpy(), y_labels.numpy())
        data.append({
            'prep': par_prep, 'donor': donor, 'region': par_brain_region,
            'group': par_status, 'celltype': par_keep_cell_type,
