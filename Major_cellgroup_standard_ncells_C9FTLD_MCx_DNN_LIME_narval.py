...
salloc -A def-grouleau --time=0-8 -c 1 --mem=150g
...
nano LIME_C9FTLD_BA4_Ex_narval_standard_n.sh
...
#SBATCH --job-name=LIME_C9FTLD_BA4_Ex_narval_standard_n
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_C9FTLD_BA4_Ex_narval_standard_n.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano LIME_C9FTLD_BA4_Ex_narval_standard_n.py
...
for keep_cell_type in par_keep_celltypes:
    ...
    ## write csv file
    file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/model_report_standard_n_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_narval.csv"
