...
nano test_SFTLD_BA9_regETM_narval_2.sh
...
#SBATCH --job-name=test_SFTLD_BA9_regETM_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_SFTLD_BA9_regETM_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_SFTLD_BA9_regETM_narval_2.py
...
for par_keep_cell_type in cell_types:
    ...
    for donor in sample_IDs:
        ...
        ## scETM model 
        model = scETM(adata_train.n_vars, adata_train.obs.batch_indices.nunique(), n_topics = 50)
    
        ## train the model 
        trainer = UnsupervisedTrainer(model, adata_train, test_ratio=0.1)
        trainer.train(n_epochs = 25, eval_every = 5, eval_kwargs = dict(cell_type_col = 'assigned_cluster'), save_model_ckpt = False) ## increase 12000
        ...
        with PdfPages('/home/fiorini9/scratch/machine_learning_ALS/temp_figures/nmf_latent_space_visualizations2.pdf') as pdf:
            # PCA plot
            pca = PCA(n_components=2)
            W_pca = pca.fit_transform(X_all)
            ...
            W_umap = reducer.fit_transform(X_all)
