...
## code DONE
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA4_diagnosis.csv')
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_genetic_BA4_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA4_genetic.csv')
...
## code -- DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_disease_BA4_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA4_disease.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        #write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_final_performance_cell_level_whole.csv')
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA4_final_performance_cell_level_top.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA4_final_performance_sample_level.csv')
...
## code
    ...
    ## code
        ...
        total_accuracy_combin$group_info <- factor(total_accuracy_combin$group_info, levels = rev(c( "Overall (n = 95)", "ALS (n = 42)", "SALS (n = 20)", "C9ALS (n = 22)", 
                                                                                                     "FTLD (n = 28)", "SFTLD (n = 13)", "C9FTLD (n = 15)", "Sporadic (n = 33)", "C9orf72 (n = 37)", "Control (n = 25)")))
...
## code DONE
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA9_diagnosis.csv')
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_genetic_BA9_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA9_genetic.csv')
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_disease_BA9_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA9_disease.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        #write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_final_performance_cell_level_whole.csv')
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA9_final_performance_cell_level_top.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/HVG_BA9_final_performance_sample_level.csv')
...
## code
    ...
    ## code
        ...
        total_accuracy_combin$group_info <- factor(total_accuracy_combin$group_info, levels = rev(c( "Overall (n = 89)", "ALS (n = 39)", "SALS (n = 17)", "C9ALS (n = 22)", 
                                                                                                     "FTLD (n = 28)", "SFTLD (n = 13)", "C9FTLD (n = 15)", "Sporadic (n = 30)", 
                                                                                                     "C9orf72 (n = 37)", "Control (n = 22)")))
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_diagnosis_BA4_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA4_diagnosis.csv')
...
## code -- DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_genetic_BA4_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA4_genetic.csv')
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_disease_BA4_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA4_disease.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        #write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_final_performance_cell_level_whole.csv')
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA4_final_performance_cell_level_top.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA4_final_performance_sample_level.csv')
...
## code
    ...
    ## code
        ...
        total_accuracy_combin$group_info <- factor(total_accuracy_combin$group_info, levels = rev(c( "Overall (n = 94)", "Overall (n = 95)", "ALS (n = 42)", "SALS (n = 20)", "C9ALS (n = 22)", 
                                                                                                     "FTLD (n = 28)", "SFTLD (n = 13)", "C9FTLD (n = 14)", "Sporadic (n = 33)", "C9orf72 (n = 37)", "Control (n = 25)")))
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_diagnosis_BA9_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA9_diagnosis.csv')
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_genetic_BA9_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA9_genetic.csv')
...
## code DONE
    ...
    ## code
        ...
        for (i in cell_type) {
        # Construct the file path for the current cell type
        file_path <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_disease_BA9_cell_true_label_',i,'_3.csv')
    ...
    ## Mean: code for barplot
        ...
        write.csv(BA4_bind_all, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA9_disease.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        #write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_final_performance_cell_level_whole.csv')
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA9_final_performance_cell_level_top.csv')
...
## code
    ...
    ## code
        ...
        ## Save final file
        write.csv(total_accuracy_combin, '/home/fiorini9/scratch/machine_learning_ALS/model_outs/NMF_BA9_final_performance_sample_level.csv')
...
## code
    ...
    ## code
        ...
        total_accuracy_combin$group_info <- factor(total_accuracy_combin$group_info, levels = rev(c( "Overall (n = 89)", "Overall (n = 95)", "ALS (n = 39)", "SALS (n = 17)", "C9ALS (n = 22)", 
                                                                                                     "FTLD (n = 28)", "SFTLD (n = 13)", "C9FTLD (n = 15)", "Sporadic (n = 30)", 
                                                                                                     "C9orf72 (n = 37)", "Control (n = 22)")))
