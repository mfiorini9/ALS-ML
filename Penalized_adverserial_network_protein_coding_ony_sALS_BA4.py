...
nano penalized_adverserial_network_sALS_BA4_protein_coding.sh
...
#SBATCH --job-name=penalized_adverserial_network_sALS_BA4_protein_coding
...
$PYTHONENV0/bin/python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/penalized_adverserial_network_sALS_BA4_protein_coding.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano penalized_adverserial_network_sALS_BA4_protein_coding.py
...
for par_keep_cell_type in celltype_list:
    ...
    df = pd.read_csv('/home/fiorini9/scratch/machine_learning_ALS/pineda_data/data_download/processed_data/191112_ALS_120_snRNA-A1/row_metadata.tsv', delimiter='\t')
    protein_coding_df = df[df['Biotype'] == 'protein_coding']
    gene_list = protein_coding_df['Gene'].dropna().tolist()
...
## write csv file
file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/model_report_{par_prep}_{par_status}_{par_brain_region}_protein_coding.csv"
...
# export to csv file
file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_index_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}.csv"
...
#feature_names=m1.var.features.tolist()

## LIME has one explainer for all the models
#explainer = lime.lime_tabular.LimeTabularExplainer(df.values, class_names=['Normal', 'Parkinson disease'], feature_names=m1.var.features.tolist(), verbose=True, mode='classification')

explainer = lime.lime_tabular.LimeTabularExplainer(df.values, class_names=['PN', 'SALS'], feature_names=adata_test.var_names.tolist(), verbose=True, mode='classification')


## Choose the 1000th instance and use it to predict the results
...
for i in range(0, num_cells):
    exp = explainer.explain_instance(df_test.values[i], main_model.predict_proba, num_features=num_genes)
    dd = exp.as_list()
    df2=pd.DataFrame(dd,) 
