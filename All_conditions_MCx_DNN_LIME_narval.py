...
nano LIME_all_conditions_BA4_Oligo_narval.sh
...
#SBATCH --job-name=LIME_all_conditions_BA4_Oligo_narval
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_all_conditions_BA4_Oligo_narval.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano LIME_all_conditions_BA4_Oligo_narval.py
...
# export to csv file
file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_index_{par_prep}_all_conditions_{par_brain_region}_{par_keep_cell_type}_narval.csv"
...
explainer = lime.lime_tabular.LimeTabularExplainer(df.values, class_names=['PN', 'all_conditions'], feature_names=adata_test.var_names.tolist(), verbose=True, mode='classification')
...
file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_{par_prep}_all_conditions_{par_brain_region}_{par_keep_cell_type}_narval.csv"
df.to_csv(file_name)
...
## write csv file
file_name = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/model_report_{par_prep}_all_conditions_{par_brain_region}_{par_keep_cell_type}_narval.csv"
