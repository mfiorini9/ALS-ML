...
nano test_All_ALS_BA4_genes_NMF_KNN_bayesian_Micro_narval_4.sh
...
#SBATCH --job-name=test_All_ALS_BA4_genes_NMF_KNN_bayesian_Micro_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_All_ALS_BA4_genes_NMF_KNN_bayesian_Micro_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_All_ALS_BA4_genes_NMF_KNN_bayesian_Micro_narval_4.py
...
###################################
# Cell Specific parameters -- Micro
###################################
...
for donor in sample_IDs:
    ...
    ###################################
    # Concatenate  HVGs and NMF
    ###################################
    # Training
    X_train.shape
    adata_train_2.X.shape
    X_train_NMF_sparse = sparse.csr_matrix(X_train)
    X_combined_train = sparse.hstack([X_train_NMF_sparse, adata_train_2.X]).tocsr()
    X_combined_train.shape
    
    # Testing
    X_test.shape
    adata_test_2.X.shape
    X_test_NMF_sparse = sparse.csr_matrix(X_test)
    X_combined_test = sparse.hstack([X_test_NMF_sparse, adata_test_2.X]).tocsr()
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/genes_NMF_KNN_bayesian_model_report2_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_narval_2.csv"
