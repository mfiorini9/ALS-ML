...
## Code BA9 All conditions --> job ID: 42103457
    module load StdEnv/2020 
    module load python/3.8.10
    PYTHONENV0=/home/fiorini9/projects/def-sfarhan/fiorini9/software/ENVscRNA
                source $PYTHONENV0/bin/activate
    ...
    nano print_meta_all_conditions_BA9_broad.sh
    ...
    #SBATCH --job-name=print_meta_all_conditions_BA9_broad
    ...
    python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/print_meta_all_conditions_BA9_broad.py

    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano print_meta_all_conditions_BA9_broad.py
...
############################################################################ Compute LIME Z score weighted and unweighted 
############################################################################
############################################################################
############################################################################ SALS BA4
## code
    ...
    nano LIME_Z_score_SALS_BA4_2.sh
    ...
    #SBATCH --job-name=LIME_Z_score_SALS_BA4_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_SALS_BA4_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_SALS_BA4_2.R
    ...
    prep <- function(celltype2){
        ...
        ## Fold 1
        DNN_LIME_m4_fold1 <- paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_',par_prep,'_',par_status,'_',par_brain_region,'_',celltype2,'_narval_2.csv')
        DNN_cell_index_m4_fold1 = paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/LIME_index_',par_prep,'_',par_status,'_',par_brain_region,'_',celltype2,'_narval_2.csv')
        ...
        write.csv(Complete_df, file = paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/pineda_LIME_unweighted_',par_prep,'_',par_status,'_',par_brain_region,'_',celltype2,'_narval_2.csv'), sep = ",")
        ...
        write.csv(Complete_df_weighted, file = paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/pineda_LIME_weighted_',par_prep,'_',par_status,'_',par_brain_region,'_',celltype2,'_narval_2.csv'), sep = ",")
    ...
    prep <- function(celltype2){
        ...
        write.csv(df, file = paste0('/home/fiorini9/scratch/machine_learning_ALS/model_outs/pineda_LIME_weighted_ordered_',par_prep,'_',par_status,'_',par_brain_region,'_',celltype2,'_narval_2.csv'), sep = ",")
    }
...
## code
    ...
    nano LIME_Z_score_C9ALS_BA4_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_C9ALS_BA4_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_C9ALS_BA4_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_C9ALS_BA4_2.R
...
## code
    ...
    nano LIME_Z_score_SFTLD_BA4_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_SFTLD_BA4_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_SFTLD_BA4_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_SFTLD_BA4_2.R
...
## code
    ...
    nano LIME_Z_score_C9FTLD_BA4_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_C9FTLD_BA4_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_C9FTLD_BA4_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_C9FTLD_BA4_2.R
...
## code
    ...
    nano LIME_Z_score_SALS_BA9_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_SALS_BA9_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_SALS_BA9_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_SALS_BA9_2.R
...
## code
    ...
    nano LIME_Z_score_C9ALS_BA9_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_C9ALS_BA9_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_C9ALS_BA9_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_C9ALS_BA9_2.R
...
## code
    ...
    nano LIME_Z_score_SFTLD_BA9_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_SFTLD_BA9_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_SFTLD_BA9_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_SFTLD_BA9_2.R
...
############################################################################
############################################################################
############################################################################ C9FTLD BA9 -------------------------------------> NEED TO FIGURE OUT WHY THE TCELL DATAFRAME IS EMPTY. 
## code
    cd /home/fiorini9/scratch/machine_learning_ALS/scripts

    nano LIME_Z_score_C9FTLD_BA9_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_C9FTLD_BA9_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_C9FTLD_BA9_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_C9FTLD_BA9_2.R
...
## code
    ...
    nano LIME_Z_score_all_conditions_BA4_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_all_conditions_BA4_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_all_conditions_BA4_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_all_conditions_BA4_2.R
...
## code
    ...
    nano LIME_Z_score_all_conditions_BA9_2.sh
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=50g          # memory per cor
    #SBATCH --job-name=LIME_Z_score_all_conditions_BA9_2
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_Z_score_all_conditions_BA9_2.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano LIME_Z_score_all_conditions_BA9_2.R
...
######################### NOT RUNNING THIS FOR NOW AT LEAST.
