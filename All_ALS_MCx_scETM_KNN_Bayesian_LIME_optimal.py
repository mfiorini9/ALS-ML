...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Fibro   ##### JOB ID: 43265174

cd /home/fiorini9/scratch/machine_learning_ALS/scripts

rm test_All_ALS_BA4_ETM_Fibro_LIME_narval_4.sh
nano test_All_ALS_BA4_ETM_Fibro_LIME_narval_4.sh
...
#SBATCH --job-name=test_All_ALS_BA4_ETM_Fibro_LIME_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_All_ALS_BA4_ETM_Fibro_LIME_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_All_ALS_BA4_ETM_Fibro_LIME_narval_4.py
...
for donor in sample_IDs:
    ...
    # Map Group numbers to names
    group_mapping = {'C9ALS': 1, 'SALS': 1, 'PN': 0}
    cell_metadata_train['Group'] = cell_metadata_train['Group'].map(group_mapping)
    cell_metadata_test['Group'] = cell_metadata_test['Group'].map(group_mapping)
