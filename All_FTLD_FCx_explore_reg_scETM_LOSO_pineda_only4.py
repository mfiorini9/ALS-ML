## For Beluga
salloc -A def-dturcan --time=0-2 -c 1 --mem=4g
...
nano test_All_FTLD_BA9_regETM_OPC_epochs_sweep_200topics_narval_4.sh
...
#SBATCH --job-name=test_All_FTLD_BA9_regETM_OPC_epochs_sweep_200topics_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_All_FTLD_BA9_regETM_OPC_epochs_sweep_200topics_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

OPC

nano test_All_FTLD_BA9_regETM_OPC_epochs_sweep_200topics_narval_4.py
...
cell_types = ["OPC"]
par_n_topics = 200
n_epochs_list = [35, 50, 100, 200, 300, 400, 500]
...
for par_keep_cell_type in cell_types:
    ...
    for par_n_epochs in n_epochs_list:
        print(par_n_epochs)
        ###################################
        # Cell Specific parameters -- OPC
        ###################################
        ...
        for donor in sample_IDs:
            ...
            group_mapping = {0: 'PN', 1: 'C9FTLD', 1: 'SFTLD'}
        ...
        out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_model_report2_{par_prep}_{par_label}_{par_brain_region}_{par_keep_cell_type}_{par_n_topics}_{par_n_epochs}_narval_2.csv"
