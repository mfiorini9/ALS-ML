...
nano metadata_QC_python_BA9.sh
...
#SBATCH --job-name=metadata_QC_python_BA9
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/metadata_QC_python_BA9.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano metadata_QC_python_BA9.py
...
for par_keep_cell_type in cell_types:
    ...
    # N HVGs
    ###################################  
    n_HVGs = adata_combined.n_vars
    
    ###################################
    # N cells
    ################################### 
    n_cells = adata_combined.obs.shape[0]
    
    ###################################
    # Mean N UMI
    ###################################   
    mean_nCount = adata_combined.obs["nCount_RNA"].mean()
    
    ###################################
    # Mean N feature
    ################################### 
    mean_nFeature = adata_combined.obs["nFeature_RNA"].mean()
    
    ###################################
    # Mean % mito
    ###################################
    mean_percent_mt = adata_combined.obs.query("Dataset != 'Limone'")["percent.mt"].mean()
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/metadata_QC_python_BA9.csv"
