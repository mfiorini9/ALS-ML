...
#SBATCH --job-name=Cell_type_subtype_BA4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/Cell_type_subtype_BA4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano Cell_type_subtype_BA4.py
...
for par_keep_cell_type in cell_types:
    ...
    adata_combined = adata_pineda_BA4
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/Cell_type_subtype_BA4.csv"
