...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Rosehip   ##### JOB ID: 43265174

cd /home/fiorini9/scratch/machine_learning_ALS/scripts

nano test_SALS_BA4_regETM_Rosehip_epochs_sweep_300topics_narval_4.sh
...
#SBATCH --job-name=test_SALS_BA4_regETM_Rosehip_epochs_sweep_300topics_narval_4
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/test_SALS_BA4_regETM_Rosehip_epochs_sweep_300topics_narval_4.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano test_SALS_BA4_regETM_Rosehip_epochs_sweep_300topics_narval_4.py
...
for donor in sample_IDs:
    ...
    trainer.train(n_epochs = par_n_epochs, eval_every = 50, eval_kwargs = dict(cell_type_col = 'assigned_cluster'), save_model_ckpt = False) ## increase 12000
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/regETM_model_report2_{par_prep}_{par_status}_{par_brain_region}_{par_keep_cell_type}_{par_n_topics}_{par_n_epochs}_narval_2_KNN_Bayesian.csv"
