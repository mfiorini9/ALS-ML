...
## code ALS BA4
    ...
    #SBATCH --job-name=combat_ALS_BA4
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/combat_ALS_BA4.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano combat_ALS_BA4.R
...
## code ALS BA9
    ...
    #SBATCH --cpus-per-task=1
    #SBATCH --mem=200g          # memory per cor
    #SBATCH --job-name=combat_ALS_BA9
    #SBATCH --error=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.err
    #SBATCH --output=/home/fiorini9/scratch/machine_learning_ALS/scripts/temp_error/job.%x-%j.out
    ...
    Rscript /home/fiorini9/scratch/machine_learning_ALS/scripts/combat_ALS_BA9.R


    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    nano combat_ALS_BA9.R
