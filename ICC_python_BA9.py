...
#SBATCH --job-name=ICC_python_BA9
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/ICC_python_BA9.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano ICC_python_BA9.py
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/ICC_python_BA9.csv"
