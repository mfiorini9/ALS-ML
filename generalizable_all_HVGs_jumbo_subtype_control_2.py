...
nano fix_generalizable_HVG_L5_ALS_jumbo_ALS_FTLD_2.sh
...
#SBATCH --job-name=fix_generalizable_HVG_L5_ALS_jumbo_ALS_FTLD_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/fix_generalizable_HVG_L5_ALS_jumbo_ALS_FTLD_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

nano fix_generalizable_HVG_L5_ALS_jumbo_ALS_FTLD_2.py
...
## Balance counts
# smallest group size
#min_count = adata_combined.obs['Group'].value_counts().min()

# downsample each group to the same size
#balanced_idx = (
#    adata_combined.obs.groupby('Group', group_keys=False)
#    .apply(lambda x: x.sample(n=min_count, random_state=0))
#    .index
#)

# subset AnnData object
#adata_combined = adata_combined[balanced_idx].copy()

#adata_combined.obs['Group'].value_counts()
...
out_path = f"/home/fiorini9/scratch/machine_learning_ALS/model_outs/All_HVGs_fix_generalizable_ALS_FTLD_control_Pineda_optimal_gene_set_weighted_LOO_LIME_0_abs_case_control_report_{par_prep}_ALS_{par_keep_cell_type}_3.csv"
