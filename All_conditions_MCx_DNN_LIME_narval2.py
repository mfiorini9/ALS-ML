...
nano LIME_all_conditions_BA4_PV_narval_2.sh

#!/bin/bash  
#SBATCH --account=def-sfarhan
#SBATCH --time=07-00:00           # time (DD-HH:MM)
#SBATCH --cpus-per-task=1
#SBATCH --mem=24g          # memory per cor
#SBATCH --job-name=LIME_all_conditions_BA4_PV_narval_2
...
python3.8 /home/fiorini9/scratch/machine_learning_ALS/scripts/LIME_all_conditions_BA4_PV_narval_2.py

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PV 

cd /home/fiorini9/scratch/machine_learning_ALS/scripts
rm LIME_all_conditions_BA4_PV_narval_2.py
nano LIME_all_conditions_BA4_PV_narval_2.py
...
par_keep_cell_type = "PV"

###################################
# Cell Specific parameters -- PV
###################################
data = []
